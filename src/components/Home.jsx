...
import {
   animationsOnMount,
   animationsOnNextMount,
   animationsOnUnMount,
   hoverEffects,
   showSocialIcons,
   hideSocialIcons,
} from '../gsap/homePageBoxesAnimations.js';
import SocialIcons from './SocialIcons';

const Home = () => {
   const { isUserMovingForward, handleSetDefaultisProjectChecked } = useContext(
      AppContext
   );
   ...
   return (
      <div className='homePage'>
         ...
         <div className='main'>
            <div className='menu'>
               ...
               <FontAwesomeIcon
                  ...
                  onClick={handleMountSocialIcons}
                  icon={faEllipsisH}
               />
               ...
               <div className='box2'>
                  {mountSocialIcons ? (
                     <SocialIcons
                        handleUnMountSocialIcons={handleUnMountSocialIcons}
                     />
                  ) : null}
               </div>
            </div>
         ...
         <footer>
            &copy; Copyright 2020 by Jakub Tarabasz. All Rights Reserved.
         </footer>
      </div>
   );
};
