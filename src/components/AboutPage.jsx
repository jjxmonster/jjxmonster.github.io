         ...
         <div className='aboutContent '>
            <div className='aboutText aboutFlex'>
               <div className='textSpace'>
                  <p id='top'>
                     I'm React Front-End Developer from Poland. I'm 18 yo and I
                     learn Front-End since april 2018 and React since 2020.
                  </p>
                  <p id='bottom'>
                     Besides coding, gym and computer games is my hobby, also i
                     like reading books, I love The Witcher of Sapkowski.
                  </p>
               </div>
            </div>
            <div className='aboutSkills aboutFlex'>
               ...
               <div className='skills'>
                  ...
                  <div className='otherSkills'>
                     ...
                     <ul>
                        <li className='beforeNode before'>
                           <p>
                              <FontAwesomeIcon
                                 className='skillsIcon'
                                 icon={faNodeJs}
                        ...
                        <li className='beforeExpress before'>
                           <p>Express.js</p>
                        </li>
                        <li>
